...
export function FailureContent() {
  ...
  const handleTryAgain = () => {
    if (normalizedRole === "CANDIDATE") {
      ...
      router.push(`/recruiter/recruiter-feature/profile/billing/confirm?package=${packageName}`);
    } else {
      router.push('/');
    }
  };
        ...
        <div className="bg-white rounded-2xl shadow-xl p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
            <Button
              ...
              className="px-8 py-6 text-lg bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
            >
